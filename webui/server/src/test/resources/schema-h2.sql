...
(
    ...
    PRIMARY KEY (`edge_id`),
    INDEX `edge_experiment_id_index` (`experiment_id`)
);
...
(
    ...
    PRIMARY KEY (`node_id`),
    INDEX `node_experiment_id_index` (`experiment_id`)
);
...
(
    ...
    INDEX `node_param_experiment_id_index` (`experiment_id`),
    INDEX `node_param_node_id_index` (`node_id`)
);